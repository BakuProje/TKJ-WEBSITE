					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/kuzuroken.20?igsh=cmI4cW01YXNqemo5" class="hover:underline">
										BAKU
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/nabil._.mosj_?igsh=ZzZoOHRodjZzajBz" class="hover:underline">
										Razy
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/tenskaje26?igsh=MXE4M2xpcGh4cnNtOQ==" class="hover:underline ">
										Instagram
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI TKJ  | Di Kelola Oleh Siswa TKJ
						</p>
					</div>
				</div>
			</div>
